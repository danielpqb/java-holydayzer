public class App {
    public static void main(String[] args) throws Exception {
        ...
        final HolidaysList holidayList = new HolidaysList(holidayArray);
        ...
        System.out.println("-------------------------");
        System.out.println(holidayList.isHoliday("24/02/2023"));
        System.out.println(holidayList.isHoliday("21/02/2023"));
    }
}
